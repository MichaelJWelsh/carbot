...
void loop(void) {
    if (controller_mode_toggled()) {
        ...
        if (left_distance < 35 && left_distance > 20 && right_distance < 35 && right_distance > 20) {
            move_forward(100);
        } else if (left_distance < 15 && left_distance > 5 && right_distance < 15 && right_distance > 5) {
            move_backward(100);
        } else if (left_distance < 15 && left_distance > 5) {
            rotate_right(100);
        } else if (right_distance < 15 && right_distance > 5) {
            rotate_left(100);
        }
    }
}
